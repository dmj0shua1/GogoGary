...
public class phLevelChangeStatus : MonoBehaviour {
    [SerializeField]
    ...
    public void PlusIntLevelStatus()
    {
        ...
        else
        {
            ...
            LevelValueHolderScript = LevelPassScript.TargetLevel.GetComponent<phLevelValueHolder>();
    ...
    { 
                if (PlayerPrefs.HasKey("phBuilding_L" + LevelPassScript.UnlockLevelAmt.ToString()))
                {
                    ...
                    LevelPassScript.RescueHolderPlayerPrefAmt = PlayerPrefs.GetInt("phBuilding_L" + LevelPassScript.UnlockLevelAmt.ToString());
