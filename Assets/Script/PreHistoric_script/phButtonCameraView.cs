...
public class phButtonCameraView : MonoBehaviour {
   ...
   //public GameObject btnNextStage;
    ...
    public void testCheckerRescue() 
    {
        ...
        if (PlayerPrefs.HasKey("phBuilding_L" + LevelStatusHolder.ToString()))
        {
            NumberOfPeopleText.text = "" + PlayerPrefs.GetInt("phBuilding_L" + LevelStatusHolder.ToString());
        }
    }
    ...
    public void LevelStatusPass(int StatusNumber) 
    {
       ...
       //DisplayLevelHolder 
       LevelDisplayHolder = StatusNumber-50;
    ...
    public void NextButton() 
    {
        ...
        if (ButtonNumberHolder <= 23)
        {
           //displayLevel
            ...
            target = BuildingButtons[ButtonNumberHolder];
            MainHolderScript.LevelStatusPass = LevelStatusHolder;
            LevelValueHolderScript = target.GetComponent<phLevelValueHolder>();
