...
public class ieButtonCameraView : MonoBehaviour {
   ...
   //public GameObject btnNextStage;
    ...
    public void testCheckerRescue() 
    {
        ...
        if (PlayerPrefs.HasKey("ieBuilding_L" + LevelStatusHolder.ToString()))
        {
            NumberOfPeopleText.text = "" + PlayerPrefs.GetInt("ieBuilding_L" + LevelStatusHolder.ToString());
        }
    }
    ...
    public void LevelStatusPass(int StatusNumber) 
    {
       ...
       //DisplayLevelHolder 
       LevelDisplayHolder = StatusNumber-75;
    ...
    public void NextButton() 
    {
        ...
        if (ButtonNumberHolder <= 23)
        {
           //displayLevel
            ...
            target = BuildingButtons[ButtonNumberHolder];
            MainHolderScript.LevelStatusPass = LevelStatusHolder;
            LevelValueHolderScript = target.GetComponent<ieLevelValueHolder>();
