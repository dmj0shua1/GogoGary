...
public class ftButtonCameraView : MonoBehaviour {
   ...
   //public GameObject btnNextStage;
    ...
    public void testCheckerRescue() 
    {
        ...
        if (PlayerPrefs.HasKey("ftBuilding_L" + LevelStatusHolder.ToString()))
        {
            NumberOfPeopleText.text = "" + PlayerPrefs.GetInt("ftBuilding_L" + LevelStatusHolder.ToString());
        }
    }
    ...
    public void LevelStatusPass(int StatusNumber) 
    {
       ...
       //DisplayLevelHolder 
       LevelDisplayHolder = StatusNumber-100;
    ...
    public void NextButton() 
    {
        ...
        if (ButtonNumberHolder <= 23)
        {
           //displayLevel
            ...
            target = BuildingButtons[ButtonNumberHolder];
            MainHolderScript.LevelStatusPass = LevelStatusHolder;
            LevelValueHolderScript = target.GetComponent<ftLevelValueHolder>();
